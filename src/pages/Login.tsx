    ...
    <div className="min-h-screen flex items-center justify-center bg-stone-50 px-6">
      ...
      >
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-serif font-light text-stone-900 mb-2">Welcome back.</h1>
          <p className="text-stone-500">Log in to continue your job search.</p>
        </div>
        ...
        <p className="text-center text-sm text-stone-500 mt-10">
          Don't have an account? <Link to="/signup" className="text-stone-900 font-medium underline underline-offset-4">Sign up</Link>
        </p>
      </motion.div>
    </div>
  );
